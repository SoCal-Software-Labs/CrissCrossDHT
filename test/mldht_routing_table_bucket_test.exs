defmodule CrissCrossDHT.RoutingTable.Bucket.Test do
  use ExUnit.Case
  ...
  test "if different value for k_bucket_size" do
    default_k = Application.get_env(:crisscrossdht, :k_bucket_size)
    new_k = 20

    # Set a new value of k
    Application.put_env(:crisscrossdht, :k_bucket_size, new_k)
    ...
    Application.put_env(:crisscrossdht, :k_bucket_size, default_k)
  end
